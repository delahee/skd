...
namespace r2{
	...
	public:
		...
		std::string&			setText(const char * str);
		std::string&			setText(const std::string & str) { setText(str.c_str()); return text; };
		...
		void					addDropShadow(float dx=0, float dy=1, r::Color col=r::Color::Black);//col manage the alpha of the dropshadow
		void					addOutline(r::Color col,float delta=1.0f);//col manage the alpha of the outline
