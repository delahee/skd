...
/* Code */
	...
	if (pStorage->mbLayer != NULL)			FREE(pStorage->mbLayer);			pStorage->mbLayer = NULL;
	if (pStorage->mb != NULL)				FREE(pStorage->mb);					pStorage->mb = NULL;
	if (pStorage->sliceGroupMap != NULL)	FREE(pStorage->sliceGroupMap);		pStorage->sliceGroupMap = NULL;
